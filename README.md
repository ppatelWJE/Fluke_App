...
To Do List
- [ ] Discuss how we should handle power factor plots for reports. 
        Current handling of the power factor plot. App plots the data as exported by fluke software. 
- [ ] Change exported file name to reflect plot title. 
